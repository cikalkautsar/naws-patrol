...
<head>
    ...
    @vite(['resources/css/landing-foster-home.css'],)
</head>
<body>
    <header class="header">
        <div class="hero">
        ...
        <div class="cat-image"><img src="{{ asset('image/foster-home/cat-landing.png') }}"/></div>
    </header>

    <div class="teks-adopsi" onclick="goToFosterInfo()" style="cursor: pointer;">
    ...
    <script>
        ...
        function goToProgressReport(petName) {
            window.location.href = `/foster-home/report?pet=${encodeURIComponent(petName)}`;
        }
        ...
        function showPetDetails(petName) {
            window.location.href = `/foster-home/form?pet=${encodeURIComponent(petName)}`;
        ...
        window.location.href = "/foster-home/info";
        }
        function goBack() {
        window.location.href = "/register-foster-home";
        }
    </script>
</body>
</html>
